...
namespace dCom.Configuration
{
    internal class ConfigItem : IConfigItem
    {
        ...
        public ConfigItem(List<string> configurationParameters)
        {
            ...
            // ScaleFactor at index 10 (# = default 1, meaning EGU value = raw value)
            if (configurationParameters.Count > 10)
            {
                ...
                {
                    Double.TryParse(configurationParameters[10], System.Globalization.NumberStyles.Float,
                        System.Globalization.CultureInfo.InvariantCulture, out doubleTemp);
                    ScaleFactor = (doubleTemp == 0) ? 1 : doubleTemp;
                }
            }
            else
            {
            ...
            // Deviation at index 11 (# = default 0)
            if (configurationParameters.Count > 11)
            {
                ...
                {
                    Double.TryParse(configurationParameters[11], System.Globalization.NumberStyles.Float,
                        System.Globalization.CultureInfo.InvariantCulture, out doubleTemp);
